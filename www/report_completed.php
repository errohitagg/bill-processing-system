...
<td width="100%">
	...
	<?php
		...
		$sql .= " bill_process.status='Completed' ORDER BY bill_process.process_id DESC LIMIT $start, 10";
		$result = mysqli_query($conn,$sql) or die("Couldn't execute query feedback_4");
		$rows=mysqli_num_rows($result);
		echo "<font size = 3 color = blue ><u><b>List of completed bills</u></b></font>";
		echo "<table width='90%'>";
			if($rows==0)
			{
